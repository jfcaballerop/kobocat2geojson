...
exports.connect2Kobo = function (username, password, kobopath) {
    return new Promise(
        function (resolve, reject) {
            ...
            // console.log(kobopath, username, password);
            request.get(kobopath, options, function (error, response, body) {
